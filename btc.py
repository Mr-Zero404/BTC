...
r = c.post("https://gymx.me/en/login",headers=ua,data={"utf8": "&#x2713;","authenticity_token": autho,"user[email]": my_namespace.email,"user[password]": my_namespace.password,"commit": "Login"})
soup = BeautifulSoup(r.text,"html.parser")
